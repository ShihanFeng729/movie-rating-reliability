...
from movie_rating_reliability.modeling import evaluate_prediction_model
...
def run_demo_pipeline(project_root: Path) -> dict[str, Any]:
    ...
    prediction = evaluate_prediction_model(demo_path)
    ...
    summary["prediction_path"] = str(prediction_path.relative_to(project_root))
